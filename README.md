...
Ironically, yes, you still need to find your token and extract your pull history. The site will not do it for you, and it was made that way intentionally. I uploaded a Python script to this repository that can extract the token and dump the pull history to a JSON file, but that completely defeats the purpose of not running random scripts you found online. Ask someone you trust to make one for you, vibe-code your own, or learn how to do manually make it by yourself.
